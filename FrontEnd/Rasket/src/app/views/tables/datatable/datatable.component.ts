...
const compare = (v1: string | number | Date, v2: string | number | Date): number => {
  if (v1 instanceof Date && v2 instanceof Date) {
    return v1.getTime() - v2.getTime(); // Compare by timestamps
  }
...
@Component({
  ...
  standalone: true,
  imports: [UIExamplesListComponent,NgbPaginationModule,CommonModule,FormsModule,NgbHighlight,NgbdSortableHeader],
