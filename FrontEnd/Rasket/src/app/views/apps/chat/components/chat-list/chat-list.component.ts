...
import { MessageData, type ContactType, type GroupType, type UserContactType } from '../../data';
import { ProfileComponent } from '../profile/profile.component';
import { SimplebarAngularModule, type SimplebarAngularComponent } from 'simplebar-angular';
import { ReactiveFormsModule, UntypedFormBuilder, Validators, type UntypedFormGroup } from '@angular/forms';
...
@Component({
  selector: 'chat-list',
  standalone: true,
  imports: [SimplebarAngularModule,ReactiveFormsModule,CommonModule,PickerModule,NgbDropdownModule],
...
export class ChatListComponent {
  ...
  openContactMenu() {
    this.offCanvas.open(ChatContactsComponent, {
